<?php
use App\Http\Controllers\DhanVentureController;
...
Route::group(['middleware' => ['islogin', 'prevent.history']], function () {
	...
	Route::match(['get', 'post'], 'viewStudents', [StudentController::class, 'viewStudents'])->name('viewStudents');
	Route::match(['get', 'post'], 'addStudents', [StudentController::class, 'addStudents']);
	Route::match(['get', 'post'], 'editStudents/{id}', [StudentController::class, 'editStudents']);
	Route::match(['get', 'post'], 'deleteStudents/{id}', [StudentController::class, 'deleteStudents']);

	Route::match(['get', 'post'], 'Schedule', [ScheduleController::class, 'Schedule'])->name('Schedule');
	Route::match(['get', 'post'], 'addSchedule', [ScheduleController::class, 'addSchedule']);
	Route::match(['get', 'post'], 'editStudents/{id}', [ScheduleController::class, 'editStudents']);
	Route::match(['get', 'post'], 'deleteStudents/{id}', [ScheduleController::class, 'deleteStudents']);



	Route::match(['get', 'post'], 'viewDhanVenture', [DhanVentureController::class, 'viewDhanVenture'])->name('viewDhanVenture');
	Route::match(['get', 'post'], 'indexDhanVenture', [DhanVentureController::class, 'indexDhanVenture'])->name('indexDhanVenture');
	Route::match(['get', 'post'], 'addDhanVenture', [DhanVentureController::class, 'addDhanVenture']);
	Route::match(['get', 'post'], 'editDhanVenture/{id}', [DhanVentureController::class, 'editDhanVenture']);
	Route::match(['get', 'post'], 'deleteDhanVenture/{id}', [DhanVentureController::class, 'deleteDhanVenture']);
