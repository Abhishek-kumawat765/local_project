...
<div class="container">
    <div class="row ">
        <div class="col-md-4">
            <a id="night" class="btn <?php echo e($night ? 'btn-success' : 'btn-primary'); ?>

" data-bs-toggle="modal" data-bs-target="#schedule" data-form="night">Night Schedule <i class="fa fa-moon"></i></a>
            <a id="exercise" class="btn <?php echo e($exercise ? 'btn-success' : 'btn-primary'); ?>" data-bs-toggle="modal"
                data-bs-target="#schedule" data-form="exercise">Exercise Schedule <i class="fa fa-dumbbell"></i></a>
            <a id="morning" class="btn <?php echo e($morning ? 'btn-success' : 'btn-primary'); ?>" data-bs-toggle="modal"
                data-bs-target="#schedule" data-form="morning">Morning Schedule <i class="fa fa-sun"></i></a>
        </div>
        <div class="col-md-4">
            <a id="rest" class="btn <?php echo e($rest ? 'btn-success' : 'btn-primary'); ?>" data-bs-toggle="modal"
                data-bs-target="#schedule" data-form="rest">Rest Schedule <i class="fa fa-bed"></i></a>
            <a id="restTwo" class="btn <?php echo e($restTwo ? 'btn-success' : 'btn-primary'); ?>" data-bs-toggle="modal"
                data-bs-target="#schedule" data-form="restTwo">Rest Two Schedule <i class="fa fa-bed"></i></a>
            <a id="restThree" class="btn <?php echo e($restThree ? 'btn-success' : 'btn-primary'); ?>" data-bs-toggle="modal"
                data-bs-target="#schedule" data-form="restThree">Rest Three Schedule <i class="fa fa-bed"></i></a>

        </div>
        <div class="col-md-4">
            <a id="study" class="btn <?php echo e($study ? 'btn-success' : 'btn-primary'); ?>" data-bs-toggle="modal"
                data-bs-target="#schedule" data-form="study">Study Schedule <i class="fa fa-book-open"></i></a>
            <a id="studyTwo" class="btn <?php echo e($studyTwo ? 'btn-success' : 'btn-primary'); ?>" data-bs-toggle="modal"
                data-bs-target="#schedule" data-form="studyTwo">Study Two Schedule <i class="fa fa-book-open"></i></a>
            <a id="studyThree" class="btn <?php echo e($studyThree ? 'btn-success' : 'btn-primary'); ?>" data-bs-toggle="modal"
                data-bs-target="#schedule" data-form="studyThree">Study Three Schedule <i
                    class="fa fa-book-open"></i></a>
            <a id="studyFourth" class="btn <?php echo e($studyFourth ? 'btn-success' : 'btn-primary'); ?>" data-bs-toggle="modal"
...
<div class="modal fade" id="schedule" tabindex="-1" aria-labelledby="scheduleLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal Form -->
            <form method="POST" action="<?php echo e(url('addSchedule')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\local_project\resources\views/Schedule/view.blade.php ENDPATH**/ ?>