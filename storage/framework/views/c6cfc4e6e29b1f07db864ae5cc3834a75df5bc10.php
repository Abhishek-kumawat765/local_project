...
<link href="<?php echo e(asset('public/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')); ?>" rel="stylesheet"
    type="text/css" />
<link href="<?php echo e(asset('public/assets/plugins/custom/datatables/datatables.bundle.css')); ?>" rel="stylesheet"
    type="text/css" />
                ...
                <div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                        ...
                        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10"
                            style="background-color: #F1416C;background-image:url('<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/patterns/vector-1.png'); ?>')">
                            <!--begin::Header-->
                            ...
                            <div class="card-body d-flex flex-column justify-content-end pe-0">
                                ...
                                <div class="symbol-group symbol-hover flex-nowrap">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        ...
                                        <img alt="Pic"
                                            src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-11.jpg'); ?>" />
                                    </div>
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Susan Redwood">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Melody Macy">
                                        <img alt="Pic"
                                            src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-2.jpg'); ?>" />
                                    </div>
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Perry Matthew">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Barry Walter">
                                        <img alt="Pic"
                                            src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-12.jpg'); ?>" />
                                    </div>
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0"
                                style="background-position: 100% 50%; background-image:url('<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/900x600/42.png'); ?>')">
                                <!--begin::Wrapper-->
                                <div class="mb-10">
                                    <!--begin::Title-->
                                ...
                                <img class="mx-auto h-150px h-lg-200px  theme-light-show"
                                    src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/illustrations/misc/upgrade.svg'); ?>"
                                    alt="" />
                                <img class="mx-auto h-150px h-lg-200px  theme-dark-show"
                                    src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/illustrations/misc/upgrade-dark.svg'); ?>"
                                    alt="" />
                                <!--end::Illustration-->
                            </div>
                            <!--end::Body-->
                ...
                <div class="row gx-5 gx-xl-10">
                    ...
                    <div class="col-xl-6 mb-5 mb-xl-10">
                        ...
                        " id="kt_stats_widget_16_tab_link_3" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_3">
                                            <!--begin::Icon-->
                                            <div class="nav-icon mb-3">
                                                <i class="ki-duotone ki-like fs-1"><span class="path1"></span><span
                                                        class="path2"></span></i>
                                            </div>
                                            <!--end::Icon-->
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-3.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-2.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-9.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-7.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-25.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-24.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-20.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-17.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-11.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-23.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-4.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-1.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-12.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-21.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-30.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-14.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-6.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-10.jpg'); ?>"
                                                                        class="" alt="" />
                                                                </div>
                                ...
                                <div class="row gx-9 h-100">
                                    ...
                                    <div class="col-sm-6 mb-10 mb-sm-0">
                                        ...
                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100"
                                            style="background-size: 100% 100%;background-image:url('<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-65.jpg'); ?>')">
                                        </div>
                                        <!--end::Image-->
                                    </div>
                                    <!--end::Col-->
                                            ...
                                            <div class="d-flex flex-stack mt-auto bd-highlight">
                                                ...
                                                <div class="symbol-group symbol-hover flex-nowrap">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle"
                                                        ...
                                                        <img alt="Pic"
                                                            src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-3.jpg'); ?>" />
                                                    </div>
                                                    <div class="symbol symbol-35px symbol-circle"
                                                ...
                                                <a href="apps/projects/project.html"
                                                    ...
                                                    <i class="ki-duotone ki-exit-right-corner fs-4 ms-1"><span
                                                            class="path1"></span><span class="path2"></span></i>
                                                </a>
                                                <!--end::Actions-->
                                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-49.jpg'); ?>"
                                                                class="" alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-40.jpg'); ?>"
                                                                class="" alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-39.jpg'); ?>"
                                                                class="" alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-47.jpg'); ?>"
                                                                class="" alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-48.jpg'); ?>"
                                                                class="" alt="" />
                                                        </div>
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-muted flex-grow-1">
                                                Finance Module </span>
                                            <i class="ki-duotone ki-cross-circle fs-1"><span class="path1"></span><span
                                                    class="path2"></span></i>
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <label class="d-flex flex-stack cursor-pointer mb-5">
                                            ...
                                            <!--begin:Input-->
                                            <span class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" checked name="framework"
                                                    value="1" />
                                            </span>
                                            <!--end:Input-->
                                        </label>
                    ...
                    <div class="py-5">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="0" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="1">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="1" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="2" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="3" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="4" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="5">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="5" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="6" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="7">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="7" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="8">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="8" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="9" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="10">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="10" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="11" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="12">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="12" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="13" />
                                        </label>
                                        <!--end::Checkbox-->
                                        ...
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic"
                                                src="https://preview.keenthemes.com/metronic8/demo1/assets/media/avatars/300-13.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="14">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="14" />
                                        </label>
                                        <!--end::Checkbox-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="15" />
                                        </label>
                                        <!--end::Checkbox-->
                                        ...
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic"
                                                src="https://preview.keenthemes.com/metronic8/demo1/assets/media/avatars/300-21.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="16">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-5">
                                            <input class="form-check-input" type="checkbox" name="users"
                                                data-kt-check="true" data-kt-check-target="" value="16" />
                                        </label>
                                        <!--end::Checkbox-->
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/illustrations/sketchy-1/1.png"
...
<script
    src="https://preview.keenthemes.com/metronic8/demo1/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
...
<script
    src="https://preview.keenthemes.com/metronic8/demo1/assets/plugins/custom/datatables/datatables.bundle.js"></script>
...
<!--end::Javascript-->
<script>
    // Check if the user has already seen the "Good Morning" message today
    const today = new Date().toDateString();
    const storedDate = localStorage.getItem('lastVisitedDate');

    if (storedDate !== today) {
        // Show the alert only if the date is different
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\local_project\resources\views/dashboards/index.blade.php ENDPATH**/ ?>