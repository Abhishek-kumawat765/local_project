                ...
                <div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                        ...
                        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10"
                            style="background-color: #F1416C;background-image:url('{{ env('IMAGE_SHOW_PATH') . 'assets/media/patterns/vector-1.png' }}')">
                            <!--begin::Header-->
                            ...
                            <div class="card-body d-flex flex-column justify-content-end pe-0">
                                ...
                                <div class="symbol-group symbol-hover flex-nowrap">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        ...
                                        <img alt="Pic"
                                            src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-11.jpg' }}" />
                                    </div>
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Susan Redwood">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Melody Macy">
                                        <img alt="Pic"
                                            src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-2.jpg' }}" />
                                    </div>
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Perry Matthew">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Barry Walter">
                                        <img alt="Pic"
                                            src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-12.jpg' }}" />
                                    </div>
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0"
                                style="background-position: 100% 50%; background-image:url('{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/900x600/42.png' }}')">
                                <!--begin::Wrapper-->
                                <div class="mb-10">
                                    <!--begin::Title-->
                                ...
                                <img class="mx-auto h-150px h-lg-200px  theme-light-show"
                                    src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/illustrations/misc/upgrade.svg' }}"
                                    alt="" />
                                <img class="mx-auto h-150px h-lg-200px  theme-dark-show"
                                    src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/illustrations/misc/upgrade-dark.svg' }}"
                                    alt="" />
                                <!--end::Illustration-->
                            </div>
                            <!--end::Body-->
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-3.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-2.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-9.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-7.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-25.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-24.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-20.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-17.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-11.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-23.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-4.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-1.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-12.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-21.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-30.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-14.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-6.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-10.jpg' }}"
                                                                        class="" alt="" />
                                                                </div>
                                ...
                                <div class="row gx-9 h-100">
                                    ...
                                    <div class="col-sm-6 mb-10 mb-sm-0">
                                        ...
                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100"
                                            style="background-size: 100% 100%;background-image:url('{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-65.jpg' }}')">
                                        </div>
                                        <!--end::Image-->
                                    </div>
                                    <!--end::Col-->
                                            ...
                                            <div class="d-flex flex-stack mt-auto bd-highlight">
                                                ...
                                                <div class="symbol-group symbol-hover flex-nowrap">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle"
                                                        ...
                                                        <img alt="Pic"
                                                            src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-3.jpg' }}" />
                                                    </div>
                                                    <div class="symbol symbol-35px symbol-circle"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-49.jpg' }}"
                                                                class="" alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-40.jpg' }}"
                                                                class="" alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-39.jpg' }}"
                                                                class="" alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-47.jpg' }}"
                                                                class="" alt="" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-48.jpg' }}"
                                                                class="" alt="" />
                                                        </div>
